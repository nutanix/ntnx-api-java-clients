...
```groovy
dependencies {
    implementation("com.nutanix.api:iam-java-client:4.0.1-alpha-1")
}
```
...
public class Sample {
  public void performOperation() {
    ...
    String extId = "^b2faF5Cc-aBB1-CeEF-ae58-db9F9bD45cFD$";
...
public class Sample {
  public void performOperation() {
    ...
    ListCertAuthProviderApiResponse listCertAuthProviderApiResponse = certAuthProviderApi.HandleListCertAuthProviders($filter, $orderby, $select);
  }
}
```
